<template>
    <div class="flex flex-col">
      <div class="gap-2 p-2 md:flex">
        ...
        <!-- <div class="md:pr-6 md:w-7/16">
          <Grid size="small" :items="about.grid"></Grid>
        </div> -->
      </div>
    </div>
  </template>
  ...
  export default {
    props: {
      about: Object, // Define a prop for passing the 'about' data to this component
    },
    data() {
      return {
        project: false,
  ...
  async asyncData({ params, $sanity }) {
    ...
    // Use the $sanity object to fetch data from Sanity
